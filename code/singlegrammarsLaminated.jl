...
#     Dense(36, 10, sigmoid)
#     )
# p1_l1 = Dense(66, 33, relu)
# p2_l1 = Dense(66, 33, relu)
# p1_l2 = Dense(33, 20, relu)
# p2_l2 = Dense(33, 20, relu)
# final_layer = Dense(40, 10, sigmoid)

# model = function(x)
#     path1_layer1 = p1_l1(x)
#     path2_layer1 = p2_l1(x)
#     path1_layer2 = p1_l2(path1_layer1)
#     path2_layer2 = p2_l2(path2_layer1)
#     join_layer = cat(path1_layer2, path2_layer2, dims=1)
#     return final_layer(join_layer)
# end
...
model = Chain(
    Parallel(vcat, 
        p1= Chain(p1_l1 = Dense(66, 33, relu), p1_l2 = Dense(33, 20, relu)), 
        p2= Chain(p2_l1 = Dense(66, 33, relu), p2_l2 = Dense(33, 20, relu)),
    ), 
    Dense(40, 10, sigmoid)
)
...
CSV.write("../data/single_model_laminated__out.csv", outDat)
